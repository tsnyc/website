...
module.exports = class AnalyticsTracker {
  ...
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "sessionId", this.getSessionId());
  ...
  getSessionId() {
    return process.gatsbyTelemetrySessionId || (process.gatsbyTelemetrySessionId = uuidv4());
  }
  ...
  formatErrorAndStoreEvent(eventType, tags) {
    if (tags.error) {
      ...
      if (Array.isArray(tags.error)) {
        const {
          error
              ...
              restOfTags = (0, _objectWithoutPropertiesLoose2.default)(tags, ["error"]);
        error.forEach(err => {
          this.formatErrorAndStoreEvent(eventType, Object.assign({
            error: err
          }, restOfTags));
        });
        return;
      ...
      tags.errorV2 = {
        ...
        stack: cleanPaths(((_tags$error2 = tags.error) === null || _tags$error2 === void 0 ? void 0 : (_tags$error2$error = _tags$error2.error) === null || _tags$error2$error === void 0 ? void 0 : _tags$error2$error.stack) || ``),
        context: cleanPaths(JSON.stringify((_tags$error3 = tags.error) === null || _tags$error3 === void 0 ? void 0 : _tags$error3.context))
      };
      delete tags.error;
    }
