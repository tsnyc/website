...
try {
  ...
  _safeSharp.default.concurrency(cpuCoreCount());
    ...
    return _regenerator.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            cacheKey = (0, _createContentDigest.default)("" + icon.src + srcIcon + srcIconDigest);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 19:
            ...
            iconDigest = (0, _createContentDigest.default)(_fs.default.readFileSync(icon)); //if cacheBusting is being done via url query icons must be generated before cache busting runs
